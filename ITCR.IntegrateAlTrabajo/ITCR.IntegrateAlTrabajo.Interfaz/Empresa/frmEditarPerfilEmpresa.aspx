<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEditarPerfilEmpresa.aspx.cs" Inherits="ITCR.IntegrateAlTrabajo.Interfaz.Empresa.frmEditarPerfilEmpresa" %>
                                ...
                                <asp:View ID="vEPPaso1" runat="server">
                                    <table class="style8">
                                        ...
                                        <tr>
                                            ...
                                            <td class="style14">
                                                <asp:TextBox ID="txtCedulaE" runat="server" Width="177px"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style14">
                                                <asp:TextBox ID="txtTelefono" runat="server" Width="181px"></asp:TextBox>
